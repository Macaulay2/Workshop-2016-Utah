...
{\color{black}\normalsize
In this final example, for instance, setting {\tt MinorsCount=>0} makes {\tt inverseOfMap} very slow, approximately the same speed as corresponding command from {\tt Cremona}.
