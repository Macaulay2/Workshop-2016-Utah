...
{\color{black}\normalsize
In the previous example, setting {\tt MinorsCount=>0} makes {\tt inverseOfMap} much slower -- approximately the same speed as corresponding command from {\tt Cremona}.
