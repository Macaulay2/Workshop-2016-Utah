...
\vskip 12pt
\noindent
\emph{Acknowledgements:}  Much of the work of the work on this package was completed during the Macaulay2 workshop held at the University of Utah in May 2016.  
...
Out package also checks whether a map $\mathfrak{F} : X \to Y$.  The strategy is quite simple.  
\begin{enumerate}
