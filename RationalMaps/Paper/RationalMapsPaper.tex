...
We now include an example where the map does not have the maximal linear rank.  %In this example, when we set {\tt MinorsLimit=>0}, the {\tt RationalMaps} function is also much much slower.
}
{\scriptsize
\color{blue}\begin{verbatim}
    i1 : loadPackage "Cremona"; loadPackage "RationalMaps";
